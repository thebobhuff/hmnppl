...
const planColors: Record<string, "default" | "outline" | "warning" | "success"> = {
  trial: "default",
  basic: "outline",
  pro: "warning",
  enterprise: "success",
...
export default function TenantsPage() {
  ...
  return (
    <PageContainer title="Tenants" description="Multi-tenant SaaS management.">
      {loading ? (
